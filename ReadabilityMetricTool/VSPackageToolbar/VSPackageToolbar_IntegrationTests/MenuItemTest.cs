...
namespace VSPackageToolbar_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(UCL.VSPackageToolbar.GuidList.guidVSPackageToolbarCmdSet, (int)UCL.VSPackageToolbar.PkgCmdIDList.cmdidTestCmd);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ReadabilityMetricTool", "UCL.VSPackageToolbar.VSPackageToolbarPackage");
