...
using UCL.VSPackageToolbar;

namespace VSPackageToolbar_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPackageToolbarPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(UCL.VSPackageToolbar.GuidList.guidVSPackageToolbarCmdSet, (int)UCL.VSPackageToolbar.PkgCmdIDList.cmdidTestCmd);
